...
class CommentManager {
  ...
  String _commentQuestionContent = "질문을 불러오지 못했습니다.";
  String? _commentAnswer;
  int _count = 0;
  ...
  String get commentQuestionContent => _commentQuestionContent;
  String? get commentAnswer => _commentAnswer;
  int get count => _count;

  void updateCommentQuestion(String question) {
    _commentQuestionContent = question;
  }

  void updateCommentAnswer(String answer) {
    _commentAnswer = answer;
  }
